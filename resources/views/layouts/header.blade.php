<header>
    ...
    <div class="bg-gradient-to-b from-[#0c0c0c] to-[#171716] flex justify-between items-center px-6 rounded-t-3xl absolute top-4 z-10 w-full">
        <nav class="flex items-center gap-8 text-2xl">
