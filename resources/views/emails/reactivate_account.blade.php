                    ...
                    <table class="wInner" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:540px;">
                        ...
                        <tr>
                            <td align="center" valign="top" style="padding: 50px 0;">
                                <a class="cta" style="background-color: #744D11; font-size: 18px; font-family: 'Trebuchet MS', Arial, sans-serif; font-weight:bold; text-decoration: none; padding: 14px 20px; color: #ffffff; display:inline-block; mso-padding-alt:0;" href="{{ $data["link"] }}"><span style="mso-text-raise:15pt;">Réactiver le compte</span></a>
                            </td>
                        </tr>
                    </table>
                </td>
